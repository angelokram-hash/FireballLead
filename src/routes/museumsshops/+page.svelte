...
<PriceWall {unlocked} onunlock={openGate}>
      ...
      <p style="font-size:0.95rem; color:var(--gray-500); line-height:1.7;">Preis: 39,90–49,90€ — der perfekte Impuls-Preis. Ideal als Mitbringsel: kompakt, elegant, mit einer Geschichte.</p>
</PriceWall>
    </div>
  </div>
</section>
